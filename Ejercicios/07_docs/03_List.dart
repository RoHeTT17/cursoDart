void main(List<String> args) {
  ...
  List<String> nombres = ['Roger','RoHETT'];
  ...
  print('indexOf: ${ nombres.indexOf('Roger') }'); // -1
  ...
  //En mayor3, se guarda la dirección de la lista, no el valor

  int mayor3 = lista.indexWhere( (numero) => (numero > 3) ? true : false );

  print( 'indexWhere mayor 3: $mayor3' );

  print('Remove: ${ nombres.remove('RoHETT') }');
